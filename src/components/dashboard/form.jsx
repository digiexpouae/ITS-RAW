...
your story</label>
   ...
   <div className="col-span-1 bg-[#FBEDDF] p-6 w-1/2 h-[180px] rounded-2xl flex flex-col justify-between">
...
If Applicable</label>
          ...
          <div className="col-span-1 bg-[#FBEDDF] w-full  h-[300px] p-4 rounded-2xl flex flex-col justify-between">
...
(optional)</label>
          <input type="file" placeholder="Write" className="border border-gray-300 bg-white rounded-md p-2 text-sm" />
                 ...
                 <div className="flex gap-4 w-full">
   <div className="col-span-1 bg-[#FBDFDF] p-4 w-1/2  h-[180px] rounded-2xl flex flex-col justify-between">
          <label className="font-medium text-sm mb-1">Speaker Role</label>
                    <input type="text" placeholder="Write" className="border border-gray-300 bg-white rounded-md p-2 text-sm" />

        </div>
            <div className="col-span-1 bg-[#FBEDDF] w-1/2 h-[180px] p-4 rounded-2xl flex flex-col justify-between">
