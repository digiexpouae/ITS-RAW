export default function CampaignForm() {
  return (
    <div className="min-h-screen bg-[#fffaf9] hidden lg:flex items-center justify-center p-8">
      <form className="flex gap-4 justify-evenly max-w-4xl w-full">
...
<div className="flex flex-col gap-4">
   ...
   <div className="col-span-1 bg-[#FBEDDF] p-4 h-[180px] rounded-2xl flex flex-col justify-between">
   ...
   <div className="col-span-1 bg-[#FBEDDF] p-6 h-[180px] rounded-2xl flex flex-col justify-between">
...
Campaign</label>
          ...
          <div className="col-span-1 bg-[#FBEDDF] h-[300px] p-4 rounded-2xl flex flex-col justify-between">
