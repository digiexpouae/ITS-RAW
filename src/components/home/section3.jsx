...
const section3=()=>{
        ...
        <div className="h-screen w-full hidden gap-4 md:flex flex-col items-center justify-center ">
            <div className="w-[80%] flex flex-col gap-4 items-center justify-center">
                {/* <div className='h-[30%] w-full flex items-center justify-center '> */}
                    {/* <Image src={'/assets/home/r-3-1.svg'} width={220 } height={220}
  ...
  {/* </div> */}
               <div className=' w-full flex flex-col items-center justify-start '  >
                       ...
                       <p className='text-xl w-[80%] text-center'>In the time it takes to fry an egg, ItsRaw will automatically create content about your restaurant and send it to the most influential people.</p>
                       </div>

            </div>
            <div className='md:w-[90%] lg:w-[80%] h-[50%] relative flex flex-col md:flex-row  items-center  justify-center'>
        ...
        <h2 className="text-[40px]  uppercase text-center leading-[0.8] mb-2" >Write It!</h2>
...
<div className='rounded-full h-full flex items-center justify-center w-[60px] bg-[#EE3A3D] relative'>
    <div className=' h-[70%] w-[70%] flex items-center justify-center'> <Image src={'/assets/home/r-3-5.svg'} width={50} height={50} className='object-cover '/></div>
        ...
        <h2 className="text-[40px]  uppercase text-center leading-[0.8] mb-2">Send It!</h2>
<p className='text-center text-xl leading-[1] px-4'>
...
<div className='rounded-full h-full flex items-center justify-center w-[60px] bg-[#EE3A3D] relative'>
    <div className=' h-[70%] w-[70%] flex items-center justify-center'> <Image src={'/assets/home/r-3-3.svg'} width={50} height={50} className='object-cover'/></div> </div></div>
        ...
        {/* mobile */}
        <div className=" p-6 py-12 w-full md:hidden flex flex-col items-center justify-center ">
            ...
            <div className='w-[80%] gap-[40px] relative flex flex-col   lg:flex-row  items-center  justify-center'>
