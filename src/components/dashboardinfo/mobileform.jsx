...
<div className="flex flex-col gap-4 w-full items-center ">
     <div className="col-span-1 bg-[#FBEDDF] w-[90%] h-[150px] p-4 rounded-2xl flex flex-col justify-between">
          ...
          <input type="email" placeholder="Example@gmail.com" className="border border-gray-300 bg-white  text-gray-500 rounded-md p-2 text-sm" />
             ...
             <div className="col-span-1 bg-[#FBDFDF] w-[90%] h-[150px] p-4 rounded-2xl flex flex-col justify-between">
